...
# Codesourcery ARM 2014.05/AArch64 2014.11 fail to link libmesa_dri_drivers.so
# with --as-needed linker # flag due to a linker bug between binutils 2.24 and
# 2.25 (2.24.51.20140217).
ifeq ($(BR2_TOOLCHAIN_EXTERNAL_CODESOURCERY_ARM)$(BR2_TOOLCHAIN_EXTERNAL_CODESOURCERY_AARCH64),y)
